//
//  SignInSearchStoreDataManager.swift
//  Albazip
//
...
class SignInSearchStoreDataManager {
    func searchStore(vc: SignInSearchStoreVC, searchText: String) {
        ...
        AF.request(url, method: .get ,parameters: parameters, headers: header)
            .validate()
            .responseDecodable(of: SignInSearchStoreResponse.self) { response in
