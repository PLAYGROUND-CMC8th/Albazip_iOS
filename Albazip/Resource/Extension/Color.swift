...
extension UIColor {
    ...
    class var disableYellow: UIColor { #colorLiteral(red: 0.9983271956, green: 0.9391896129, blue: 0.7384549379, alpha: 1)}
    class var enableYellow: UIColor { #colorLiteral(red: 1, green: 0.849331677, blue: 0.3616983294, alpha: 1)}
}
